...
public class EmployeController {
	...
	public String authenticateUser(
		@Valid @RequestBody Employe loginRequest) throws JsonProcessingException {
	...
	public String createUser(@RequestBody Employe signUpRequest) throws Exception {
		...
		try {
			...
			System.out.println("Voir le nom complet de la personne recuperé:" + employe.getNomComplet());
			

			List<String> messages = new ArrayList<>();
			messages.add(String.format("%s  a été creé avec succès", employe.getId()));
			reponse = new Reponse<Employe>(0, messages, employe);

		} catch (Exception e) {
			reponse = new Reponse<Employe>(1, GestionDesExceptions.getErrorForException(e), null);
		}
		return mapper.writeValueAsString(reponse);
	}
	...
	public String lister() throws JsonProcessingException {
		...
		try {
			...
			// TODO: handle exception
			reponse = new Reponse<List<Employe>>(1,GestionDesExceptions.getErrorForException(e), null);
	...
	public String supprimer(@PathVariable Long id) throws JsonProcessingException {
		...
		try {
			...
			// TODO: handle exception
			reponse = new Reponse<Boolean>(1,GestionDesExceptions.getErrorForException(e),null);
		}
		return mapper.writeValueAsString(reponse);
	}
